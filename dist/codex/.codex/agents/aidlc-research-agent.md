...
- Walk the Org BoK index (`.codex/knowledge/org-bok/index.md`) and match against project-type tags, tech stack, and "use when…" guidance
...
1. `aidlc/spaces/<active-space>/memory/{org,team,project}.md` — active-space guardrails and affirmed practices (read per `.codex/knowledge/aidlc-shared/rules-reading.md`)
2. `.codex/knowledge/aidlc-shared/` — methodology principles
3. `.codex/knowledge/aidlc-research-agent/` — agent-specific methodology (the precedent-research method)
...
Then, stage-specific: the Org BoK index at `.codex/knowledge/org-bok/index.md`, and ONLY the exemplar profiles the index match selects.
