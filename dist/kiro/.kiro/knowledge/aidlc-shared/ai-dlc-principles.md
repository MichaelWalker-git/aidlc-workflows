...
Not every task requires all 33 stages. Scopes (enterprise, feature, mvp, poc, bugfix, refactor, infra, security-patch, workshop) determine which stages execute and at what depth.
