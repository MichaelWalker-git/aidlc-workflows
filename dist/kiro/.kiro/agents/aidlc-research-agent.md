...
- Walk the Org BoK index (`.kiro/knowledge/org-bok/index.md`) and match against project-type tags, tech stack, and "use when…" guidance
...
1. `aidlc/spaces/<active-space>/memory/{org,team,project}.md` — active-space guardrails and affirmed practices (read per `.kiro/knowledge/aidlc-shared/rules-reading.md`)
2. `.kiro/knowledge/aidlc-shared/` — methodology principles
3. `.kiro/knowledge/aidlc-research-agent/` — agent-specific methodology (the precedent-research method)
...
Then, stage-specific: the Org BoK index at `.kiro/knowledge/org-bok/index.md`, and ONLY the exemplar profiles the index match selects.
