...
Then, standing org defaults: the Org BoK code-style guide at `.claude/knowledge/org-bok/guides/code-style.md` and the UI design-language guide at `.claude/knowledge/org-bok/guides/ui-design-language.md` (if they exist) — org-wide defaults that apply even when precedent-research was skipped, subject to the precedence rule the guides state.
