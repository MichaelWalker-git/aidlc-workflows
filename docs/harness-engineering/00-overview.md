...
on the harness you use — Claude Code, Kiro CLI, Kiro IDE, Codex CLI, or opencode: 15 agents
(12 domain experts, 2 reviewers, and the composer), 33 stages, 9 scopes, a set
