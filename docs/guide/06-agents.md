...
AI-DLC ships 15 agent personas: 12 domain experts that execute stage work, 2 review-only agents, and the adaptive-workflows composer. This chapter explains the full roster, beginning with the domain agents and then covering the reviewers and composer.

---

## Philosophy: Small Mob, Broad Agents

Rather than dozens of narrow specialists (which recreates waterfall handoff chains), AI-DLC uses **12 broadly capable agents** that each participate across multiple stages and phases.
...
Beyond the 12 domain-expert agents, AI-DLC ships **2 quality-gate reviewer
