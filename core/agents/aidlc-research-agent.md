...
- Walk the Org BoK index (`{{HARNESS_DIR}}/knowledge/org-bok/index.md`) and match against project-type tags, tech stack, and "use when…" guidance
...
3. `{{HARNESS_DIR}}/knowledge/aidlc-research-agent/` — agent-specific methodology (the precedent-research method)
...
Then, stage-specific: the Org BoK index at `{{HARNESS_DIR}}/knowledge/org-bok/index.md`, and ONLY the exemplar profiles the index match selects.
